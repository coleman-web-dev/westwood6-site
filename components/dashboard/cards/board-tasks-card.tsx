...
import { ClipboardCheck, CalendarCheck, CheckCircle2 } from 'lucide-react';
...
export function BoardTasksCard() {
  ...
  const [counts, setCounts] = useState<TaskCounts>({ pendingReservations: 0, pendingInspections: 0 });
  ...
  const totalTasks = counts.pendingReservations + counts.pendingInspections;
